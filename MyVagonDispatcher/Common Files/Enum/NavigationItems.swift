...
enum NavItemsLeft {
    case none, back, chat , chatList, ReloadBack
...
enum NavItemsRight {
    case none,skip,chat,notification,RequestEdit ,contactus,search,option,reset,chatDirect,editPersonalInfo,editPaymentDetails,editLicenceDetails,editProfile,editDriver
