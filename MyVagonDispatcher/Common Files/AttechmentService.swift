...
class AttachmentHandler: NSObject{
    ...
    func showLimited(){
        let controller = AppStoryboard.Popup.instance.instantiateViewController(withIdentifier: SelectImagePopUpVC.storyboardID) as! SelectImagePopUpVC
        controller.modalPresentationStyle = .automatic
        controller.modalTransitionStyle = .coverVertical
        controller.clickEdit = { (image) in
