...
extension AppDelegate{
    ...
    func userNotificationCenter(_ center: UNUserNotificationCenter, didReceive response: UNNotificationResponse, withCompletionHandler completionHandler: @escaping () -> Void) {
        ...
        if let mainDic = userInfo as? [String: Any]{
            ...
            if pushObj.type == NotificationTypes.driverPostings.rawValue{
                if(UIApplication.appTopViewController()?.isKind(of: NewScheduleVC.self) ?? false){
                    AppDelegate.pushNotificationObj = nil
                    AppDelegate.pushNotificationType = nil
                    NotificationCenter.default.post(name: .RefreshViewForPostTruck, object: nil)
                }else{
...
extension Notification.Name {
    ...
    static let RefreshViewForPostTruck = NSNotification.Name("RefreshViewForPostTruck")
...
enum NotificationTypes : String {
    ...
    case driverPostings = "driver_postings"
