...
class PostTruckViewController: BaseViewController {
    ...
    @IBOutlet weak var lblSelectDriver: themeLabel!
    ...
    func setLocalization() {
        self.lblTitleTruckType.text = ""//.localized
        self.lblSelectDriver.text = "select_driver".localized
        self.btnSelectDriver.setTitle("select_driver".localized, for: .normal)
...
//            formatter.pmSymbol = "PM"
    ...
    func Validate() -> (Bool,String) {
        if selectedDriverId == ""{
            return (false,"empty_driver_massage".localized)
        }else if LblSelectedDate.text?.lowercased() == "selected date" {
    ...
    @IBAction func btnSelectDriver(_ sender: Any) {
        SingletonClass.sharedInstance.getDriverList { data in
...
extension PostTruckViewController{
    func CallWebSerive(){
        ...
        ReqModelForPostTruck.driver_id = selectedDriverId
