...
class ForgotPasswordVC: BaseViewController {
    ...
    func setLocalization() {
        ...
        txtPhone.placeholder = "Phone number".localized
    ...
    func validate() -> (Bool,String) {
        ...
        let checkEmail = self.txtPhone.validatedText(validationType: ValidatorType.requiredField(field: "Phone number".localized))
        if (!checkEmail.0){
            return checkEmail
        }
        return (true,"")
