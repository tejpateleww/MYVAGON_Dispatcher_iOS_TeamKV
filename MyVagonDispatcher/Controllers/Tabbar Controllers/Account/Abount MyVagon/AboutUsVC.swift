...
class AboutUsVC: BaseViewController {
    ...
    func setupUI(){
        ...
        self.setNavigationBarInViewController(controller: self, naviColor: .clear, naviTitle: "About MYVAGON".localized, leftImage: NavItemsLeft.back.value, rightImages: [], isTranslucent: true)
        self.registerNib()
    }
    
    func setupData(){
        self.arrData = ["Privacy Policy".localized,"Terms and Conditions".localized,"About us".localized]
