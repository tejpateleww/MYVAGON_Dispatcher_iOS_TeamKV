...
class RelatedMatchesVC: BaseViewController {
    ...
    //MARK: - Custom methods
    func setupUI(){
        setNavigationBarInViewController(controller: self, naviColor: .clear, naviTitle: "Related_Matches".localized, leftImage: NavItemsLeft.ReloadBack.value, rightImages: [], isTranslucent: true, ShowShadow: true)
    }
