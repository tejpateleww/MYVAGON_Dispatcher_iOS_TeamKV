...
class SearchVC: BaseViewController {
    ...
    func addObserver(){
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(self.refresh(_:)), name: Notification.Name(rawValue: "reloadsearch"), object: nil)
    }
...
//        self.checkLocationPermission()
    ...
    func setupforCustomerConnection() {
        let profile = SingletonClass.sharedInstance.DispatcherProfileData
